        ...
        return (
            <div className='article'>
              <div className="article__control">
                <div className="article__edit" onClick={ this.props.editItem } >
                  <svg className='article__svg-icon' version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 55.25 55.25">
                ...
                <div className="article__remove" onClick={ this.props.removeItem }>
                  <svg className='article__svg-icon' version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 482.428 482.429">
                    <g>
                      <g>
